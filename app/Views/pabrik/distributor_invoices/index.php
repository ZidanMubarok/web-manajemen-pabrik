...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
            ...
            <div class="card-body">
                <form action="<?= base_url('pabrik/distributor-invoices') ?>" method="get">
                    <div class="row align-items-end g-2">
                        <!-- ... Kolom input filter Anda (invoiceNumber, status, startDate, endDate) tetap sama ... -->
                        <div class="col-md-2">
                        ...
                        <!-- PERUBAHAN DI SINI: Grup Tombol -->
                        <div class="col-md-3 d-flex align-items-end">
                            <div class="btn-group w-100" role="group">
                                <button type="submit" class="btn btn-primary me-2" title="Terapkan Filter"><i class="fas fa-search"></i> Cari</button>

                                <?php
                                // Siapkan parameter untuk link ekspor
                                $filterParams = [
                                ...
                                <!-- Tombol Export Baru -->
                                <a href="<?= base_url('pabrik/distributor-invoices/export') . ($exportQuery ? '?' . $exportQuery : '') ?>" class="btn btn-success me-1" title="Export ke Excel">
        ...
        <!-- ... sisa dari view Anda (tabel, modal, script) tidak perlu diubah ... -->
    </div>
            ...
            <div class="d-flex justify-content-between align-items-center mt-4">
                <div class="text-muted">
                    ...
                    if (!empty($invoices)) {
                        ...
                        echo "Menampilkan <b>{$firstItem}</b> sampai<b>{$lastItem}</b> dari <b>{$total}</b> Tagihan Distributor.";
                    } else {
