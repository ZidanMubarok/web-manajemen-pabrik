...
<div class="container-fluid pt-4">
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
                            ...
                            foreach ($incomingOrders as $order) : ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php
                                        // ### PERUBAHAN: Konfigurasi status diperbarui ###
                                        $statusConfig = [
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-end">
                                                ...
                                                <?php if ($order['status'] == 'approved') : ?>
                                                    <!-- ### PERUBAHAN: Opsi Proses dan Tolak ### -->
            ...
            <!-- ... (Blok Pager Anda tidak perlu diubah) ... -->
        </div>
    </div>
</div>

<!-- ### PERUBAHAN: Formulir disesuaikan ### -->
<form id="statusUpdateForm" action="" method="post" style="display: none;">
    <?= csrf_field() ?>
    <input type="hidden" name="status" id="newStatusInput">
    <input type="hidden" name="rejection_reason" id="rejectionReasonInput"> <!-- Input untuk alasan penolakan -->
</form>

<!-- ### PERUBAHAN: JavaScript diganti dengan versi yang lebih canggih ### -->
<script>
    // Inisialisasi Tooltip (jika masih digunakan)
