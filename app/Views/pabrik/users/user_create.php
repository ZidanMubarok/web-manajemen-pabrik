...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary">
            <h6 class="m-0 font-weight-bold text-white"><i class="fas fa-user-plus me-2"></i> Form Tambah Distributor</h6>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('pabrik/users/store') ?>" method="post">
                <?= csrf_field() ?>
                ...
                <div class="alert alert-info mt-4" role="alert">
                    <i class="fas fa-info-circle"></i> Pengguna ini akan dibuat dengan peran sebagai <strong>Distributor</strong> di bawah manajemen Anda.
                </div>

                <div class="d-flex justify-content-end">
                    <a href="<?= base_url('pabrik/users') ?>" class="btn btn-secondary me-2"><i class="fas fa-times me-1"></i> Batal</a>
