...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 bg-primary">
            <h6 class="m-0 font-weight-bold text-white"><i class="fas fa-user-edit me-2"></i> Form Edit Distributor</h6>
        </div>
        <div class="card-body">
            ...
            <form action="<?= base_url('pabrik/users/update/' . $user['id']) ?>" method="post">
                <?= csrf_field() ?>
