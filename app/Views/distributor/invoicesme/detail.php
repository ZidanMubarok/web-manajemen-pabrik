...
<?= $this->section('head') ?>
<!-- Menambahkan style khusus untuk proses pencetakan yang lebih kuat -->
<!-- <style>
    @media print {
        /* Sembunyikan elemen-elemen umum dari template admin */
        ...
        /* Footer halaman */
        hr,
        /* Garis horizontal di luar konten cetak */
        ...
        /* Pastikan body tidak memiliki padding atau margin yang mengganggu */
        body {
        ...
        /* Targetkan pembungkus utama konten agar menjadi satu-satunya yang terlihat */
        #wrapper #content-wrapper {
            padding: 0;
            margin: 0;
        }

        /* Sembunyikan semua elemen di dalam pembungkus konten */
        #content-wrapper>* {
            visibility: hidden;
        }

        /* Tampilkan hanya area yang kita inginkan */
        #invoice-content,
        #invoice-content * {
            visibility: visible;
        }

        /* Posisikan area cetak ke bagian atas halaman */
        #invoice-content {
            position: absolute;
            left: 0;
            top: 0;
        ...
        /* Hilangkan box-shadow atau border yang tidak perlu dari card saat dicetak */
        .card.shadow {
...
<!-- Menambahkan style khusus untuk proses pencetakan -->
<style>
    @media print {
        ...
        /* Tampilkan elemen yang ingin dicetak dan semua elemen di dalamnya */
        #invoice-content,
        #invoice-content * {
            visibility: visible;
        }

        /* Pastikan konten yang dicetak menempati seluruh halaman */
        #invoice-content {
            position: absolute;
            left: 0;
            top: 0;
        ...
        /* (Opsional) Sembunyikan header card saat mencetak untuk tampilan lebih bersih */
        .card-header {
            display: none;
        }
    }
...
<div class="container-fluid">
    <!-- Area ini adalah yang akan kita cetak -->
    <div id="invoice-content">
        <h1 class="mb-4"><?= $title ?></h1>

        <div class="card shadow mb-4">
            <div class="card-header py-3 bg-primary text-white">
                <h6 class="m-0 font-weight-bold"><i class="fas fa-info-circle me-2"></i> Detail Tagihan Saya<?= esc($invoice['invoice_number']) ?></h6>
            </div>
            <div class="card-body">
                <div class="row mb-4">
                    <div class="col-md-6">
                        <h5>Informasi Tagihan Saya</h5>
...
<script>
    // Tidak ada perubahan yang diperlukan di sini. window.print() akan menggunakan style @media print secara otomatis.
    ...
    async function downloadPdfInvoice() {
        ...
        try {
            ...
            const pageHeight = 200; // Tinggi A4 dalam mm
